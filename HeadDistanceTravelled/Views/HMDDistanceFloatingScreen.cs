...
namespace HeadDistanceTravelled.Views
{
    ...
    internal class HMDDistanceFloatingScreen : BSMLAutomaticViewController, IInitializable
    {
        ...
        public void Initialize()
        {
            ...
            if (CustomConfig.ConfData.HDTPosFix) {
                this._floatingScreen.transform.position = new Vector3(CustomConfig.ConfData.HDTPosX, CustomConfig.ConfData.HDTPosY, CustomConfig.ConfData.HDTPosZ);
            }            
        ...
        //private static readonly Vector3 s_localOffset = new Vector3(0, 0.1f, 1.2f);
