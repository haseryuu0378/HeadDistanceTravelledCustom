...
namespace HeadDistanceTravelled
{
    ...
    internal class HeadDistanceTravelledController : MonoBehaviour, IHeadDistanceTravelledController
    {
        ...
        private static DateTime? StartDt = null ;
        #endregion
        //ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*ﾟ+｡｡+ﾟ*｡+ﾟ ﾟ+｡*
        #region // 構築・破棄
        [Inject]
        ...
        public void Start()
        {
            ...
            Plugin.Log.Info($"HeadDistanceTravelledCustom_CustomConfig={CustomConfig.ConfData.StartDt},{StartDt},{CustomConfig.ConfData.ResultFormat},{CustomConfig.ConfData.HDTPosFix}");
        ...
        public void OnDestroy()
        {
            ...
            //Plugin.Log.Info($"HeadDistanceTravelledCustom={totalDistance},{preDistance},{CustomConfig.ConfData.StartDt},{StartDt},{CustomConfig.ConfData.ResultFormat}");
            //Plugin.Log.Info($"HeadDistanceTravelledCustom={TextOutResultController.GetTextOutOath()}");

            TextOutResultController.TextOutResult((Math.Ceiling(totalDistance * 100) / 100).ToString(), (Math.Ceiling(preDistance * 100) / 100).ToString(), CustomConfig.ConfData.ResultFormat);
